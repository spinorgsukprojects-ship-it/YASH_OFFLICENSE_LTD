  ...
  return (
    <section className="section bg-cream">
      <div className="container max-w-3xl text-center">
        ...
        <h1 className="mt-6 font-heading text-4xl font-black md:text-5xl">Page Not Found</h1>
        <p className="mt-4 text-lg leading-8 text-slateText">
          The page you are looking for may have moved. You can return home or contact Yash Off Licence.
        </p>
