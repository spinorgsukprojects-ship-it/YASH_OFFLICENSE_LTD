...
export const metadata: Metadata = {
  ...
  description: "Privacy information for enquiries submitted to Yashofflicense LTD.",
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyPage title="Privacy Policy">
      ...
      <p>We may collect your name, email address, phone number, business name, company number, service request, application or licence type, renewal date, preferred contact method, subject, message, submission date, page URL, and enquiry reference.</p>
      <h2>Why We Collect It</h2>
      <p>This information is used to respond to your enquiry, understand the support requested, prepare administrative assistance, and keep appropriate records of communications.</p>
...
function PolicyPage({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <>
      <section className="section bg-mist"><div className="container max-w-4xl"><h1 className="font-heading text-4xl font-extrabold md:text-5xl">{title}</h1></div></section>
